<template>
    <div style="min-height: 1000px; background-color: #f6f6f8">
        <div style="height: 200px; background-color: #3b526a; padding: 30px 0">
            <div style="width: 80%; margin: 0 auto">
                ...
                <div style="margin-top: 20px">
                    <el-button :disabled="!data.user && data.user.role !== 'USER'" type="success"
                               style="padding: 20px 30px" @click="collect">收藏岗位
                    </el-button>
                    <el-button :disabled="!data.user && data.user.role !== 'USER'" type="info"
                               style="padding: 20px 30px" @click="submitInit">投递简历
                    </el-button>
                </div>
            </div>
        </div>
        <div style="margin: 20px auto; width: 80%; display: flex">
            <div
                style="flex: 1; margin-right: 10px; min-height: 500px; background-color: white; border-radius: 10px; padding: 20px 30px">
                <div style="font-size: 20px; font-weight: bold; color: #222222">职位描述</div>
                <div style="margin-top: 15px">
                    <el-tag type="info" v-for="item in data.positionData.tagList" style="margin-right: 10px">{{
                            item
                        }}
                    </el-tag>
                </div>
            ...
            <div style="width: 300px; margin-left: 5px">
                <div
                    style="text-align: center; background-color: #d1d7d7; color: #222222; font-size: 16px; line-height: 40px; font-weight: bold; border-top-left-radius: 10px; border-top-right-radius: 10px">
                    公司基本信息
                </div>
                <div
                    style="background-color: white; padding: 20px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px">
                    <div style="display: flex; align-items: center; margin-bottom: 10px">
                        <img :src="data.positionData.employAvatar" alt=""
                             style="margin-right: 10px; width: 40px; height: 40px; border-radius: 10px; border: 1px solid #cccccc">
                        <div style="color: #414a60; font-size: 18px; margin-left: 10px">{{
                                data.positionData.employName
                            }}
                        </div>
                    </div>
                ...
                <div
                    style="margin-top: 20px; text-align: center; background-color: #d1d7d7; color: #222222; font-size: 16px; line-height: 40px; font-weight: bold; border-top-left-radius: 10px; border-top-right-radius: 10px">
                    你可能对这些职位感兴趣
                </div>
...
import {Coordinate, User, OfficeBuilding} from "@element-plus/icons-vue";
